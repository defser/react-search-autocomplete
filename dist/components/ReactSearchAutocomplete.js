...
function ReactSearchAutocomplete(_a) {
    var _b = _a.items, items = _b === void 0 ? [] : _b, _c = _a.fuseOptions, fuseOptions = _c === void 0 ? config_1.defaultFuseOptions : _c, _d = _a.inputDebounce, inputDebounce = _d === void 0 ? exports.DEFAULT_INPUT_DEBOUNCE : _d, _e = _a.onSearch, onSearch = _e === void 0 ? function () { } : _e, _f = _a.onHover, onHover = _f === void 0 ? function () { } : _f, _g = _a.onSelect, onSelect = _g === void 0 ? function () { } : _g, _h = _a.onFocus, onFocus = _h === void 0 ? function () { } : _h, _j = _a.onClear, onClear = _j === void 0 ? function () { } : _j, _k = _a.handleSearch, handleSearch = _k === void 0 ? function () { } : _k, _l = _a.showIcon, showIcon = _l === void 0 ? true : _l, _m = _a.showClear, showClear = _m === void 0 ? true : _m, _o = _a.maxResults, maxResults = _o === void 0 ? exports.MAX_RESULTS : _o, _p = _a.placeholder, placeholder = _p === void 0 ? '' : _p, _q = _a.autoFocus, autoFocus = _q === void 0 ? false : _q, _r = _a.styling, styling = _r === void 0 ? {} : _r, _s = _a.resultStringKeyName, resultStringKeyName = _s === void 0 ? 'name' : _s, _t = _a.inputSearchString, inputSearchString = _t === void 0 ? '' : _t, formatResult = _a.formatResult, _u = _a.showNoResults, showNoResults = _u === void 0 ? true : _u, _v = _a.showNoResultsText, showNoResultsText = _v === void 0 ? 'No results' : _v, _w = _a.showItemsOnFocus, showItemsOnFocus = _w === void 0 ? false : _w;
    ...
    var _z = (0, react_1.useState)(0), highlightedItem = _z[0], setHighlightedItem = _z[1];
    ...
    return ((0, jsx_runtime_1.jsx)(styled_components_1.ThemeProvider, __assign({ theme: theme }, { children: (0, jsx_runtime_1.jsx)(StyledReactSearchAutocomplete, { children: (0, jsx_runtime_1.jsxs)("div", __assign({ className: "wrapper" }, { children: [(0, jsx_runtime_1.jsx)(SearchInput_1.default, { searchString: searchString, setSearchString: handleSetSearchString, resetSearchString: handleResetSearchString, autoFocus: autoFocus, onFocus: handleOnFocus, onClear: onClear, handleSearch: handleSearch, placeholder: placeholder, showIcon: showIcon, showClear: showClear, hasFocus: hasFocus, setHighlightedItem: handleSetHighlightedItem }), (0, jsx_runtime_1.jsx)(Results_1.default, { results: results, onClick: handleOnClick, setSearchString: setSearchString, showIcon: showIcon, maxResults: maxResults, resultStringKeyName: resultStringKeyName, formatResult: formatResult, highlightedItem: highlightedItem, setHighlightedItem: handleSetHighlightedItem, showNoResultsFlag: showNoResultsFlag, showNoResultsText: showNoResultsText })] })) }) })));
}
