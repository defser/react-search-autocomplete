...
var GoIcon_1 = require("./GoIcon");
function SearchInput(_a) {
    var searchString = _a.searchString, setSearchString = _a.setSearchString, resetSearchString = _a.resetSearchString, setHighlightedItem = _a.setHighlightedItem, autoFocus = _a.autoFocus, onFocus = _a.onFocus, onClear = _a.onClear, handleGo = _a.handleGo, placeholder = _a.placeholder, hasFocus = _a.hasFocus, _b = _a.showIcon, showIcon = _b === void 0 ? true : _b, _c = _a.showClear, showClear = _c === void 0 ? true : _c;
    var ref = (0, react_1.useRef)(null);
    var manualFocus = true;
    var handleOnFocus = function (event) {
        manualFocus && onFocus(event);
    };
    return ((0, jsx_runtime_1.jsxs)(StyledSearchInput, { children: [(0, jsx_runtime_1.jsx)(SearchIcon_1.SearchIcon, { showIcon: showIcon }), (0, jsx_runtime_1.jsx)("input", { ref: ref, spellCheck: false, value: searchString, onChange: setSearchString, onFocus: handleOnFocus, placeholder: placeholder, autoFocus: autoFocus, onKeyDown: function (event) { return setHighlightedItem({ event: event }); }, "data-test": "search-input", type: "search" }), (0, jsx_runtime_1.jsx)(GoIcon_1.GoIcon, { hasFocus: hasFocus, searchString: searchString, handleGo: handleGo }), (0, jsx_runtime_1.jsx)(ClearIcon_1.ClearIcon, { hasFocus: hasFocus, showClear: showClear, resetSearchString: resetSearchString, searchString: searchString, onClear: onClear })] }));
}
